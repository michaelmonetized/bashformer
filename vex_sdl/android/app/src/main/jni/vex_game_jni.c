...
#include "../../shared/vex.c"

#define LOG_TAG "VexGame"
...
Java_com_vex_vexsdl_VexGameJNI_init(JNIEnv *env, jobject thiz, jobject assetManager) {
    LOGI("Initializing Vex Game JNI");
    ...
    LOGI("Vex Game JNI initialized");
}

JNIEXPORT void JNICALL
Java_com_vex_vexsdl_VexGameJNI_cleanup(JNIEnv *env, jobject thiz) {
    LOGI("Cleaning up Vex Game JNI");
...
JNIEXPORT void JNICALL
Java_com_vex_vexsdl_VexGameJNI_onSurfaceCreated(JNIEnv *env, jobject thiz, jint width, jint height) {
...
JNIEXPORT void JNICALL
Java_com_vex_vexsdl_VexGameJNI_onSurfaceChanged(JNIEnv *env, jobject thiz, jint width, jint height) {
...
JNIEXPORT void JNICALL
Java_com_vex_vexsdl_VexGameJNI_update(JNIEnv *env, jobject thiz, 
                                         jdouble deltaTime,
                                         jboolean moveLeft,
                                         jboolean moveRight,
                                         jboolean jump,
...
JNIEXPORT void JNICALL
Java_com_vex_vexsdl_VexGameJNI_render(JNIEnv *env, jobject thiz, jobject canvas) {
