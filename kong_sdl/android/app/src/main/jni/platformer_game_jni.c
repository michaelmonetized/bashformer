...
#include "../../shared/platformer_sdl.c"
...
Java_com_platformer_platformersdl_PlatformerGameJNI_init(JNIEnv *env, jobject thiz, jobject assetManager) {
...
JNIEXPORT void JNICALL
Java_com_platformer_platformersdl_PlatformerGameJNI_cleanup(JNIEnv *env, jobject thiz) {
...
JNIEXPORT void JNICALL
Java_com_platformer_platformersdl_PlatformerGameJNI_onSurfaceCreated(JNIEnv *env, jobject thiz, jint width, jint height) {
...
JNIEXPORT void JNICALL
Java_com_platformer_platformersdl_PlatformerGameJNI_onSurfaceChanged(JNIEnv *env, jobject thiz, jint width, jint height) {
...
JNIEXPORT void JNICALL
Java_com_platformer_platformersdl_PlatformerGameJNI_update(JNIEnv *env, jobject thiz, 
                                         jdouble deltaTime,
                                         jboolean moveLeft,
                                         jboolean moveRight,
                                         jboolean jump,
...
JNIEXPORT void JNICALL
Java_com_platformer_platformersdl_PlatformerGameJNI_render(JNIEnv *env, jobject thiz, jobject canvas) {
